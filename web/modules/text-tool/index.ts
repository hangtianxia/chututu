...
export class TextTool {
  ...
  private getFont(opts: Omit<IFontParam, 'use'>, extraOpts?: TFontParam) {
    ...
    // Use a robust cross-platform CJK fallback chain to avoid odd font substitution metrics.
    font += 'PingFang SC, Hiragino Sans GB, Microsoft YaHei, Noto Sans CJK SC, Noto Sans SC, Noto Sans, sans-serif';
